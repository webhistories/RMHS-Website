...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="panel">
    ...
    <span style="font-size:25px; color:black"><center><strong>Manage Events</strong></center></span> 
...
<table class="table table-striped table-bordered table-hover" id="Accounts">
            ...
            <?php
                ...
                $query=mysqli_query($conn,"SELECT * FROM events ORDER BY start_date");
                while($row=mysqli_fetch_array($query)){
                    ?>
                    <tr>
                        <td><a href="cashier (item).html"><?php echo $row['title']; ?></a></td>
    ...
    <?php include('add_modalEvent.php');
?>
