...
<html lang="en">
<head>
  <title>RMHS - Manage Events</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="panel">
    ...
    <span style="font-size:25px; color:black"><center><strong>Manage News</strong></center></span> 
...
<table class="table table-striped table-bordered table-hover" id="Accounts">
            ...
            <?php
                ...
                $query=mysqli_query($conn,"SELECT * FROM doc ORDER BY date_published");
                while($row=mysqli_fetch_array($query)){
                    ?>
                    <tr>
                        <td><a href="cashier (item).html"><?php echo $row['title1']; ?></a></td>
                        <td><?php echo $row['title2']; ?></td>
                          <td><?php echo date('F j, Y', strtotime($row['date_published'])); ?></td>
